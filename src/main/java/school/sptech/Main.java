...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            while( sc.hasNextLine() ){
                ...
                processos.add( new Processo(campos[0],Integer.valueOf(campos[1]),campos[2],Double.valueOf(campos[3]),Double.valueOf(campos[5]),Long.valueOf(campos[7]),Long.valueOf(campos[8]) ) );
    ...
    public static void sumarizar(List<Processo> processos){
        try{
            ...
            bw.write("Timestamp,Pid,Nome,,Cpu,TotalRAM,Ram,TempoVida,BytesLidos,BytesEscritos,StatusCPU,StatusRAM,StatusDISCO,\n");
